...
from .routers import admin, appspace, auth, cron, dev, hubs, public, uploads, webhooks, whatsapp
...
for r in (public, auth, appspace, admin, uploads, webhooks, cron, dev, whatsapp, hubs):
